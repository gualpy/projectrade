...
<body class="login-page" style="background-image:url('../../assets/dist/img/dashboard_xl-2015.jpg');background-size:cover; background-repeat:no-repeat;background-position:center center;">
<div class="login-box">
  ...
  <div class="card">
    ...
    <img src="../../assets/img/projectradelogo.png" style="width: 250px; height: 200px; margin: auto; display:block;" alt="Where Money work for you">
      ...
      <form action="<?php echo base_url(route_to('forgot')); ?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" name="c-password" placeholder="Confirm Password" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
